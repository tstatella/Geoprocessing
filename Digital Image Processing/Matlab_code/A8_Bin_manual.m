...
Get = imread('gaussian_shaded.tif');

%binarização manual
Lm = 0.2;%limiar manual
BinManual = im2bw(Get,Lm);

%binarização por Otsu
BinOtsu = im2bw(Get,graythresh(Get));

%Usando suavização por média
h = fspecial('average',[5 5]);
S = imfilter(Get,h,'replicate','same'); 
BinS = im2bw(S,graythresh(S));

%fazendo particionamento
%linha 1
P11 = Get(1:325,1:271);
P12 = Get(1:325,272:542);
P13 = Get(1:325,543:814);
%linha 2
P21 = Get(326:651,1:271);
P22 = Get(326:651,272:542);
P23 = Get(326:651,543:814);
